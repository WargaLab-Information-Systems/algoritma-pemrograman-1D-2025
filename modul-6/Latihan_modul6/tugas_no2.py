print("PROGRAM PENGGABUNGAN DAN PENGURUTAN TUPLE MAC ALLISTER\n")
while True:
    try:
        data1 = input("Masukkan elemen tuple pertama (pisahkan dengan tanda koma): ")
        elemen1 = data1.split(",")
...
while True:
    try:
        data2 = input("Masukkan elemen tuple kedua (pisahkan dengan tanda koma): ")
        elemen2 = data2.split(",")
        tuple2 = tuple(int(i) for i in elemen2)
        break
    except:
        print("Input tidak valid! Pastikan hanya memasukkan angka dan dipisahkan dengan tanda koma.\nSilakan masukkan ulang.\n")
